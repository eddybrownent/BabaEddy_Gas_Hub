...
const ConfirmationScreen = () => {
  ...
  const { phoneNumber, address } = route.params;
  ...
  return (
    <View className="bg-white flex-1">
      ...
      {/* Render user details */}
      <View style={{ margin: 20, padding: 20, borderRadius: 10, backgroundColor: '#fff', elevation: 4 }}>
      ...
      <TouchableOpacity
        ...
        >
        <Text className="text-white text-center font-bold text-lg">confirm and pay</Text>
      </TouchableOpacity>
      </View>
      </View>
    </View>
